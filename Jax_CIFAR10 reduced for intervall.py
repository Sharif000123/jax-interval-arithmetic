...
def init_params(key):
    ...
    fc1_key, fc2_key, fc3_key, fc4_key, fc1_bias_key, fc2_bias_key, fc3_bias_key, fc4_bias_key = jax.random.split(key, 8)
    
    params = {"fc1_kernel": jax.nn.initializers.glorot_uniform()(fc1_key,(3072, 512),jnp.float32),  # (in_features, out_features)")
              "fc2_kernel": jax.nn.initializers.glorot_uniform()(fc2_key,(512, 256),jnp.float32),
              "fc3_kernel": jax.nn.initializers.glorot_uniform()(fc3_key,(256, 120),jnp.float32),
              "fc4_kernel": jax.nn.initializers.glorot_uniform()(fc4_key,(120, 10),jnp.float32),
              # normalverteilung lequ normal
              "fc1_bias": jax.nn.initializers.lecun_normal()(fc1_bias_key,(512, 1), jnp.float32).squeeze(),
              "fc2_bias": jax.nn.initializers.lecun_normal()(fc2_bias_key,(256, 1), jnp.float32).squeeze(),
              "fc3_bias": jax.nn.initializers.lecun_normal()(fc3_bias_key,(120, 1), jnp.float32).squeeze(),
              "fc4_bias": jax.nn.initializers.lecun_normal()(fc4_bias_key,(10, 1), jnp.float32).squeeze()
...
def Net(params, x):
    ...
    fc_k4 = params["fc4_kernel"]  # (in_features, out_features)
    bias4 = params["fc4_bias"]
