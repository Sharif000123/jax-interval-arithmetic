...
def eval_jaxpr(jaxpr, consts, *args):
    ...
    safe_map(write, jaxpr.invars, args) # here safe_map is used to apply the write function to each element in jaxpr.invars and args
    safe_map(write, jaxpr.constvars, consts) # here safe_map is used to apply the write function to each element in jaxpr.constvars and consts
    
    # Loop through equations and eval primitives using `bind`
    for eqn in jaxpr.eqns: #
        #read input to eq. env.
